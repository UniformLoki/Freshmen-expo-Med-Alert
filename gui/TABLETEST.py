...
with app.app_context():
    ...
    # add_medication(1, "Concerta", "27mg", 30, 0.025, ["07:00 AM"])
    # add_medication(1, "Calcium Gummy", "500mg", 100, 0.5, ["11:30 PM"])
    # add_medication(2, "Antibiotic", "150mg", 15, 0.025, ["09:30 AM", "09:30 PM"])
    # add_medication(2, "Allergy Meds", "1,000mg", 200, 0.025, ["09:30 AM", "09:30 PM"])
    # add_medication(1, "Midol", "150mg", 50, 0.025, ["08:00 AM", "07:30 PM"])
